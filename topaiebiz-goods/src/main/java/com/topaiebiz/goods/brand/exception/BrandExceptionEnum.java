...
public enum BrandExceptionEnum implements ExceptionInfo{
	...
	BRAND_BRANDCODE_NOT_REPETITION("2000001", "Goods brand code cannot be repeated!"),
	
	BRAND_NAME_NOT_REPETITION("2000002", "Goods brand name cannot be repeated!"),
	
	BRAND_ID_NOT_NULL("2000003", "Goods brand ID cannot be empty!"),
	
	BRAND_ID_NOT_EXIST("2000004", "Goods brand ID does not exist!");
