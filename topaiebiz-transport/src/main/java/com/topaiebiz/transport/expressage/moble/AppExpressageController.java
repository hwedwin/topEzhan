package com.topaiebiz.transport.expressage.moble;
 ...
 */
@RestController
@RequestMapping("/app/transport/expressage")
public class AppExpressageController {
	
	/**访问路径，随时更改。*/
	private String urlPath = "http://101.132.106.86::8888";
